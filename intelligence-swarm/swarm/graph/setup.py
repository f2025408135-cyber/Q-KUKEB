...
from swarm.agents.managers.qkukeb_executor import create_qkukeb_executor
from swarm.agents.utils.agent_states import AgentState
...
class GraphSetup:
    ...
    def setup_graph(
        ...
        workflow.add_node("Q-KUKEB Executor", qkukeb_executor_node)
        ...
        workflow.add_conditional_edges(
            ...
            self.conditional_logic.should_continue_risk_analysis,
            {
                ...
                "Q-KUKEB Executor": "Q-KUKEB Executor",
            },
        )
        workflow.add_conditional_edges(
        ...
        workflow.add_edge("Q-KUKEB Executor", END)
